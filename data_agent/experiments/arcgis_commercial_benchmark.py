...
def build_arcgis_parity_matrix() -> pd.DataFrame:
    ...
    rows = [
        ...
        },
        {
            ...
            "scca_status": "partial",
            "commercial_priority": "P0",
            "evidence_artifact": "GPS-style ERF and adjusted outcome workflows",
            "next_action": "Add ArcGIS-named score fields and later optional gradient boosting parity.",
        },
        {
        ...
        },
        {
            ...
            "scca_status": "partial",
            "commercial_priority": "P0",
            "evidence_artifact": "balance diagnostics and evidence-grade rules",
            "next_action": "Add ArcGIS-compatible mean, median, and max absolute-correlation fields.",
        },
        {
