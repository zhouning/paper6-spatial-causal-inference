...
- [x] Conservative 8,000-word readiness audit completed on 2026-07-05, treating the remembered IJGIS main-text-plus-references limit as binding until the live portal confirms exact wording: LaTeX source counts are 5,832 words excluding figure/table environments and 7,489 including them; `pdftotext` full-PDF token counts are 7,932 non-anonymous and 7,926 anonymous.
