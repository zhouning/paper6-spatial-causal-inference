...
| overall_arcgis_surpass_readiness      | overall_gate                 | not_yet_claimable   |    2           |           nan      | 0                                                             | all_scorecard_rows         | Evidence supports partial wins, but not a broad ArcGIS-superiority claim yet.                    | Add additional real ArcGIS comparisons and close open synthetic/default-ERF gaps.                           |
