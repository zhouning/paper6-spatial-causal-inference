...
| direct_arcgis_real_dataset_coverage | evidence_coverage            | insufficient_evidence |    1           |           nan      | 3                                      | all_arcgis_available_rows  | Only a small number of real datasets have direct ArcGIS built-in comparisons.                    | Add additional real ArcGIS comparisons before claiming broad superiority.                                   |
