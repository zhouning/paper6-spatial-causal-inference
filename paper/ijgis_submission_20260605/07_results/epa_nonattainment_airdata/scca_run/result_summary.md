...
- After adding neighboring exposure, the main coefficient is -1.000; the neighbor-exposure coefficient is 5.54e-11 (p=0.342).
...
- Spatial diagnostics use coordinate_knn with 20740 edges; exposure Moran's I is -0.079 (p=0.010) and residual Moran's I is 0.876 (p=0.010).
