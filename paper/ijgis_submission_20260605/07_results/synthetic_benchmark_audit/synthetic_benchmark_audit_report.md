...
- `Granger`: robust=2, bounded=2, fragile=0, preferred=`standard`/bounded, preferred_fragile=0, diagnostic_fragile=0, score_range=[0.67, 1.00]
...
- `PSM` / `noisy_outcome` / `naive_difference`: fragile; normalized_rmse=0.593 exceeded 0.40; estimate_mean=2.382e+04, rmse=8892
...
- `Granger` / `noisy_outcome` / `standard`: robust; direction_accuracy=1.00 met robust threshold; estimate_mean=1, rmse=0
- `Granger` / `baseline` / `standard`: robust; direction_accuracy=1.00 met robust threshold; estimate_mean=1, rmse=0
