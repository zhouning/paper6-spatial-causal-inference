...
- `gis_run_summary.json` records an evidence grade, generated-file list, selected ArcGIS-style bins/scale, calibrated balance, calibration diagnostics, and ArcGIS-style ERF diagnostics.
